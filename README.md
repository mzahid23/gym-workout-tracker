...
Workout Progress Tracker — Full-Stack Project  
React, Flask, SQL, JWT, Recharts

- Built a full-stack fitness tracking app allowing users to log workouts, exercises, sets, reps, and weight with secure authentication.
- Designed a relational SQL database to store users, workouts, exercises, and training sets.
- Implemented progress dashboards showing workout volume, total workouts, total sets, and personal training history.
- Created a clean GitHub-ready project structure with setup instructions and planned deployment improvements.
```
